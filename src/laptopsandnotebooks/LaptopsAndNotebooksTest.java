...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyProductsPriceDisplayHighToLowSuccessfully() {
        ...
        mouseHoverOnElements(By.xpath("//a[normalize-space()='Laptops & Notebooks']"));
        ...
        String actualProduct1 = getTextElement(By.xpath("(//div[@class='product-thumb']//h4//a)[1]"));
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        String actualMessage = getTextElement(By.xpath("//h1[normalize-space()='MacBook']"));
        ...
        String actualMessage2 = getTextElement(By.xpath("//h1[contains(text(),'Shopping Cart')]"));
        Assert.assertTrue(actualMessage2.contains(expectedMessage2));

        // 2.10 Verify the Product name "MacBook"
        String expectedMessage3 = "MacBook";
        String actualMessage3 = getTextElement(By.xpath("(//a[contains(text(),'MacBook')])[2]"));
...
//        2.13 Verify the message “Success: You have modified your shopping cart!”
        String expectedMessage4 = "Success: You have modified your shopping cart!\n" +
                "    ";
        String actualMessage4 = getTextElement(By.xpath("//div[@class='alert alert-success alert-dismissible']"));
        Assert.assertEquals(expectedMessage4, actualMessage4);
//        2.14 Verify the Total £737.45
        expectedMessage = "$1,204.00";
        actualMessage = getTextElement(By.xpath("(//td[contains(text(),'$1,204.00')])[4]"));
        Assert.assertEquals(expectedMessage, actualMessage);
...
//        2.16 Verify the text “Checkout”
        ...
        String actualMessage5 = getTextElement(By.xpath("//h1[normalize-space()='Checkout']"));
        Assert.assertEquals(expectedMessage5, actualMessage5);
//        2.17 Verify the Text “New Customer”
        String expectedMessage6 = "New Customer";
        String actualMessage6 = getTextElement(By.xpath("//h2[normalize-space()='New Customer']"));
...
//        2.25 Verify the message “Warning: Payment method required!”
        ...
        String actualMessage7 = getTextElement(By.xpath("//div[@class='alert alert-danger alert-dismissible']"));
