...
public class MyAccountsTest extends Utility {
    ...
    public void verifyUserShouldNavigateToRegisterPageSuccessfully() {
      ...
      //“Register”
        ...
        String actualMessage = getTextElement(By.xpath("//h1[normalize-space()='Register Account']"));
    ...
    public void verifyUserShouldNavigateToLoginPageSuccessfully() {
      ...
      //2.3 Verify the text “Returning Customer”.
        ...
        String actualMessage = getTextElement(By.xpath("//h2[normalize-space()='Returning Customer']"));
        Assert.assertEquals(expectedMessage, actualMessage);
     ...
     //3.1 Clickr on My Account Link.
      ...
      //“Register”
       ...
       //3.12 Verify the message “Your Account Has Been Created!”
        ...
        String actualMessage = getTextElement(By.xpath("//h1[normalize-space()='Your Account Has Been Created!']"));
        Assert.assertEquals(expectedMessage, actualMessage);
       ...
       //3.16 Verify the text “Account Logout”
        ...
        String actualMessage1 = getTextElement(By.xpath("//h1[normalize-space()='Account Logout']"));
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
       ...
       //4.6 Click on Login button
        ...
        String actualMessage1 = getTextElement(By.xpath("//h2[normalize-space()='My Account']"));
        Assert.assertEquals(expectedMessage1, actualMessage1);
       ...
       //4.10 Verify the text “Account Logout”
        ...
        String actualMessage2 = getTextElement(By.xpath("//h1[normalize-space()='Account Logout']"));
